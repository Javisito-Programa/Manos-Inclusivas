...
// Si ya estÃ¡ logueado, redirigir a noticias
        ...
        if (isset($pdo)) {
            ...
            if ($attempt_data) {
                ...
                if ($attempt_data['attempts'] >= 5 && $diff_minutes < 15) {
                    ...
                    // Resetear intentos si ya pasÃ³ el tiempo de castigo
            ...
            if (!$is_blocked) {
                ...
                // Usamos password_verify que es el estÃ¡ndar mÃ¡s seguro (BCRYPT / ARGON2I)
                if ($user && password_verify($password, $user['password_hash'])) {
                    // Inicio de sesiÃ³n exitoso: Limpiar intentos fallidos
                    ...
                    // Decodificar permisos y guardarlos en sesiÃ³n
...
<body class="login-body">
    ...
    <!-- Fondo de PartÃ­culas interactivo -->
